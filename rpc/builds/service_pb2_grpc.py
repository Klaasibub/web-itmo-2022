...
class AddServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                '/AddService/Add',
                request_serializer=service__pb2.AddArgs.SerializeToString,
...
def add_AddServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Add': grpc.unary_unary_rpc_method_handler(
                    servicer.Add,
                    request_deserializer=service__pb2.AddArgs.FromString,
...
class AddService(object):
    ...
    def Health(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/AddService/Health',
    ...
    def Add(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/AddService/Add',
            service__pb2.AddArgs.SerializeToString,
